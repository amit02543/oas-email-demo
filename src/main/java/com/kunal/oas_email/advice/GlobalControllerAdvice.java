package com.kunal.oas_email.advice;

import com.kunal.oas_email.constant.CommonConstants;
import com.kunal.oas_email.exception.OasException;
import com.kunal.oas_email.model.ErrorDetails;
import com.kunal.oas_email.util.CommonUtility;
...
public class GlobalControllerAdvice {
    ...
    @ExceptionHandler(OasException.class)
    public ResponseEntity<ErrorDetails> OasExceptionHandler(OasException ex,
                                                           WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails()
                .setTimestamp(commonUtility.getFormattedCurrentTimestamp())
